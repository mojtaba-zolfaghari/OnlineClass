...
namespace DNTFrameworkCore.TestWebApp.Authorization
{
    public class AuthorizationProvider : IAuthorizationProvider
    {
        public IEnumerable<Permission> ProvidePermissions()
        {
            ...
            yield return Permission.CreatePermission(PermissionNames.Academy_View,
     L(PermissionNames.Academy_View));
            yield return Permission.CreatePermission(PermissionNames.Academy_Create,
                L(PermissionNames.Academy_Create));
            yield return Permission.CreatePermission(PermissionNames.Academy_Edit,
                L(PermissionNames.Academy_Edit));
            yield return Permission.CreatePermission(PermissionNames.Academy_Delete,
                L(PermissionNames.Academy_Delete));
