namespace DNTFrameworkCore.TestWebApp.Authorization
{
    ...
    {
        public const string Blogs_View = nameof(Blogs_View);
        ...
        public const string Academy_View = nameof(Academy_View);
        public const string Academy_Create = nameof(Academy_Create);
        public const string Academy_Edit = nameof(Academy_Edit);
        public const string Academy_Delete = nameof(Academy_Delete);
        ...
        public const string Tasks_View = nameof(Tasks_View);
